...
type CallOrder_Server interface {
	GetCallSequence(ctx context.Context, opts C.CallOptions, params CallOrder_getCallSequence_Params, results CallOrder_getCallSequence_Results) error
}
...
func CallOrder_Methods(methods []C.ServerMethod, server CallOrder_Server) []C.ServerMethod {
	...
	methods = append(methods, C.ServerMethod{
		...
		Impl: func(c context.Context, opts C.CallOptions, p, r C.Struct) error {
			return server.GetCallSequence(c, opts, CallOrder_getCallSequence_Params(p), CallOrder_getCallSequence_Results(r))
		},
...
type Echoer_Server interface {
	Echo(ctx context.Context, opts C.CallOptions, params Echoer_echo_Params, results Echoer_echo_Results) error
...
func Echoer_Methods(methods []C.ServerMethod, server Echoer_Server) []C.ServerMethod {
	...
	methods = append(methods, C.ServerMethod{
		...
		Impl: func(c context.Context, opts C.CallOptions, p, r C.Struct) error {
			return server.Echo(c, opts, Echoer_echo_Params(p), Echoer_echo_Results(r))
		},
		ResultsSize: C.ObjectSize{DataSize: 0, PointerCount: 1},
	})
