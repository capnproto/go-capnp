...
type Conn struct {
	...
	mu sync.Mutex // mu protects all the following fields in lk.
	// lk contains all the fields protected by mu; this makes it easy
	// to tell at call sites whether you should or should not be holding
	// the lock.
	lk struct {
