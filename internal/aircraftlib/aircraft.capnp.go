...
func (s Zdate) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

func (s Zdate) Year() int16      { return int16(C.Struct(s).Uint16(0)) }
func (s Zdate) SetYear(v int16)  { C.Struct(s).SetUint16(0, uint16(v)) }
func (s Zdate) Month() uint8     { return C.Struct(s).Uint8(2) }
func (s Zdate) SetMonth(v uint8) { C.Struct(s).SetUint8(2, v) }
func (s Zdate) Day() uint8       { return C.Struct(s).Uint8(3) }
func (s Zdate) SetDay(v uint8)   { C.Struct(s).SetUint8(3, v) }

type Zdate_List C.PointerList

func NewZdate_List(s *C.Segment, sz int32) Zdate_List {
...
func (s Zdate_List) Set(i int, item Zdate) { C.PointerList(s).Set(i, C.Pointer(item)) }
...
func (s Zdata) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

func (s Zdata) Data() []byte     { return C.Struct(s).Pointer(0).ToData() }
func (s Zdata) SetData(v []byte) { C.Struct(s).SetPointer(0, s.Segment().NewData(v)) }

type Zdata_List C.PointerList

func NewZdata_List(s *C.Segment, sz int32) Zdata_List {
...
func (s Zdata_List) Set(i int, item Zdata) { C.PointerList(s).Set(i, C.Pointer(item)) }
...
type Airport_List C.UInt16List

func NewAirport_List(s *C.Segment, sz int32) Airport_List { return Airport_List(s.NewUInt16List(sz)) }
...
func (s PlaneBase) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

func (s PlaneBase) Name() string            { return C.Struct(s).Pointer(0).ToText() }
func (s PlaneBase) SetName(v string)        { C.Struct(s).SetPointer(0, s.Segment().NewText(v)) }
func (s PlaneBase) Homes() Airport_List     { return Airport_List(C.Struct(s).Pointer(1)) }
func (s PlaneBase) SetHomes(v Airport_List) { C.Struct(s).SetPointer(1, C.Pointer(v)) }
func (s PlaneBase) Rating() int64           { return int64(C.Struct(s).Uint64(0)) }
func (s PlaneBase) SetRating(v int64)       { C.Struct(s).SetUint64(0, uint64(v)) }
func (s PlaneBase) CanFly() bool            { return C.Struct(s).Bit(64) }
func (s PlaneBase) SetCanFly(v bool)        { C.Struct(s).SetBit(64, v) }
func (s PlaneBase) Capacity() int64         { return int64(C.Struct(s).Uint64(16)) }
func (s PlaneBase) SetCapacity(v int64)     { C.Struct(s).SetUint64(16, uint64(v)) }
func (s PlaneBase) MaxSpeed() float64       { return math.Float64frombits(C.Struct(s).Uint64(24)) }
func (s PlaneBase) SetMaxSpeed(v float64)   { C.Struct(s).SetUint64(24, math.Float64bits(v)) }

type PlaneBase_List C.PointerList

func NewPlaneBase_List(s *C.Segment, sz int32) PlaneBase_List {
...
func (s PlaneBase_List) Set(i int, item PlaneBase) { C.PointerList(s).Set(i, C.Pointer(item)) }
...
func (s B737) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

func (s B737) Base() PlaneBase     { return PlaneBase(C.Struct(s).Pointer(0).ToStruct()) }
func (s B737) SetBase(v PlaneBase) { C.Struct(s).SetPointer(0, C.Pointer(v)) }

type B737_List C.PointerList

func NewB737_List(s *C.Segment, sz int32) B737_List {
...
func (s B737_List) Set(i int, item B737) { C.PointerList(s).Set(i, C.Pointer(item)) }
...
func (s A320) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

func (s A320) Base() PlaneBase     { return PlaneBase(C.Struct(s).Pointer(0).ToStruct()) }
func (s A320) SetBase(v PlaneBase) { C.Struct(s).SetPointer(0, C.Pointer(v)) }

type A320_List C.PointerList

func NewA320_List(s *C.Segment, sz int32) A320_List {
...
func (s A320_List) Set(i int, item A320) { C.PointerList(s).Set(i, C.Pointer(item)) }
...
func (s F16) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

func (s F16) Base() PlaneBase     { return PlaneBase(C.Struct(s).Pointer(0).ToStruct()) }
func (s F16) SetBase(v PlaneBase) { C.Struct(s).SetPointer(0, C.Pointer(v)) }

type F16_List C.PointerList

func NewF16_List(s *C.Segment, sz int32) F16_List {
...
func (s F16_List) Set(i int, item F16) { C.PointerList(s).Set(i, C.Pointer(item)) }
...
func (s Regression) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

func (s Regression) Base() PlaneBase           { return PlaneBase(C.Struct(s).Pointer(0).ToStruct()) }
func (s Regression) SetBase(v PlaneBase)       { C.Struct(s).SetPointer(0, C.Pointer(v)) }
func (s Regression) B0() float64               { return math.Float64frombits(C.Struct(s).Uint64(0)) }
func (s Regression) SetB0(v float64)           { C.Struct(s).SetUint64(0, math.Float64bits(v)) }
func (s Regression) Beta() C.Float64List       { return C.Float64List(C.Struct(s).Pointer(1)) }
func (s Regression) SetBeta(v C.Float64List)   { C.Struct(s).SetPointer(1, C.Pointer(v)) }
func (s Regression) Planes() Aircraft_List     { return Aircraft_List(C.Struct(s).Pointer(2)) }
func (s Regression) SetPlanes(v Aircraft_List) { C.Struct(s).SetPointer(2, C.Pointer(v)) }
func (s Regression) Ymu() float64              { return math.Float64frombits(C.Struct(s).Uint64(8)) }
func (s Regression) SetYmu(v float64)          { C.Struct(s).SetUint64(8, math.Float64bits(v)) }
func (s Regression) Ysd() float64              { return math.Float64frombits(C.Struct(s).Uint64(16)) }
func (s Regression) SetYsd(v float64)          { C.Struct(s).SetUint64(16, math.Float64bits(v)) }

type Regression_List C.PointerList

func NewRegression_List(s *C.Segment, sz int32) Regression_List {
...
func (s Regression_List) Set(i int, item Regression) { C.PointerList(s).Set(i, C.Pointer(item)) }
...
func (s Aircraft) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

func (s Aircraft) Which() Aircraft_Which {
	return Aircraft_Which(C.Struct(s).Uint16(0))
}

func (s Aircraft) SetVoid()   { C.Struct(s).SetUint16(0, 0) }
func (s Aircraft) B737() B737 { return B737(C.Struct(s).Pointer(0).ToStruct()) }
func (s Aircraft) SetB737(v B737) {
	C.Struct(s).SetUint16(0, 1)
	C.Struct(s).SetPointer(0, C.Pointer(v))
}
func (s Aircraft) A320() A320 { return A320(C.Struct(s).Pointer(0).ToStruct()) }
func (s Aircraft) SetA320(v A320) {
	C.Struct(s).SetUint16(0, 2)
	C.Struct(s).SetPointer(0, C.Pointer(v))
}
func (s Aircraft) F16() F16     { return F16(C.Struct(s).Pointer(0).ToStruct()) }
func (s Aircraft) SetF16(v F16) { C.Struct(s).SetUint16(0, 3); C.Struct(s).SetPointer(0, C.Pointer(v)) }

type Aircraft_List C.PointerList

func NewAircraft_List(s *C.Segment, sz int32) Aircraft_List {
...
func (s Aircraft_List) Set(i int, item Aircraft) { C.PointerList(s).Set(i, C.Pointer(item)) }
...
func (s Z) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

func (s Z) Which() Z_Which {
	return Z_Which(C.Struct(s).Uint16(0))
}

func (s Z) SetVoid()     { C.Struct(s).SetUint16(0, 0) }
func (s Z) Zz() Z        { return Z(C.Struct(s).Pointer(0).ToStruct()) }
func (s Z) SetZz(v Z)    { C.Struct(s).SetUint16(0, 1); C.Struct(s).SetPointer(0, C.Pointer(v)) }
func (s Z) F64() float64 { return math.Float64frombits(C.Struct(s).Uint64(8)) }
func (s Z) SetF64(v float64) {
	C.Struct(s).SetUint16(0, 2)
	C.Struct(s).SetUint64(8, math.Float64bits(v))
}
func (s Z) F32() float32 { return math.Float32frombits(C.Struct(s).Uint32(8)) }
func (s Z) SetF32(v float32) {
	C.Struct(s).SetUint16(0, 3)
	C.Struct(s).SetUint32(8, math.Float32bits(v))
}
func (s Z) I64() int64      { return int64(C.Struct(s).Uint64(8)) }
func (s Z) SetI64(v int64)  { C.Struct(s).SetUint16(0, 4); C.Struct(s).SetUint64(8, uint64(v)) }
func (s Z) I32() int32      { return int32(C.Struct(s).Uint32(8)) }
func (s Z) SetI32(v int32)  { C.Struct(s).SetUint16(0, 5); C.Struct(s).SetUint32(8, uint32(v)) }
func (s Z) I16() int16      { return int16(C.Struct(s).Uint16(8)) }
func (s Z) SetI16(v int16)  { C.Struct(s).SetUint16(0, 6); C.Struct(s).SetUint16(8, uint16(v)) }
func (s Z) I8() int8        { return int8(C.Struct(s).Uint8(8)) }
func (s Z) SetI8(v int8)    { C.Struct(s).SetUint16(0, 7); C.Struct(s).SetUint8(8, uint8(v)) }
func (s Z) U64() uint64     { return C.Struct(s).Uint64(8) }
func (s Z) SetU64(v uint64) { C.Struct(s).SetUint16(0, 8); C.Struct(s).SetUint64(8, v) }
func (s Z) U32() uint32     { return C.Struct(s).Uint32(8) }
func (s Z) SetU32(v uint32) { C.Struct(s).SetUint16(0, 9); C.Struct(s).SetUint32(8, v) }
func (s Z) U16() uint16     { return C.Struct(s).Uint16(8) }
func (s Z) SetU16(v uint16) { C.Struct(s).SetUint16(0, 10); C.Struct(s).SetUint16(8, v) }
func (s Z) U8() uint8       { return C.Struct(s).Uint8(8) }
func (s Z) SetU8(v uint8)   { C.Struct(s).SetUint16(0, 11); C.Struct(s).SetUint8(8, v) }
func (s Z) Bool() bool      { return C.Struct(s).Bit(64) }
func (s Z) SetBool(v bool)  { C.Struct(s).SetUint16(0, 12); C.Struct(s).SetBit(64, v) }
func (s Z) Text() string    { return C.Struct(s).Pointer(0).ToText() }
func (s Z) SetText(v string) {
	C.Struct(s).SetUint16(0, 13)
	C.Struct(s).SetPointer(0, s.Segment().NewText(v))
}
func (s Z) Blob() []byte { return C.Struct(s).Pointer(0).ToData() }
func (s Z) SetBlob(v []byte) {
	C.Struct(s).SetUint16(0, 14)
	C.Struct(s).SetPointer(0, s.Segment().NewData(v))
}
func (s Z) F64vec() C.Float64List { return C.Float64List(C.Struct(s).Pointer(0)) }
func (s Z) SetF64vec(v C.Float64List) {
	C.Struct(s).SetUint16(0, 15)
	C.Struct(s).SetPointer(0, C.Pointer(v))
}
func (s Z) F32vec() C.Float32List { return C.Float32List(C.Struct(s).Pointer(0)) }
func (s Z) SetF32vec(v C.Float32List) {
	C.Struct(s).SetUint16(0, 16)
	C.Struct(s).SetPointer(0, C.Pointer(v))
}
func (s Z) I64vec() C.Int64List { return C.Int64List(C.Struct(s).Pointer(0)) }
func (s Z) SetI64vec(v C.Int64List) {
	C.Struct(s).SetUint16(0, 17)
	C.Struct(s).SetPointer(0, C.Pointer(v))
}
func (s Z) I32vec() C.Int32List { return C.Int32List(C.Struct(s).Pointer(0)) }
func (s Z) SetI32vec(v C.Int32List) {
	C.Struct(s).SetUint16(0, 18)
	C.Struct(s).SetPointer(0, C.Pointer(v))
}
func (s Z) I16vec() C.Int16List { return C.Int16List(C.Struct(s).Pointer(0)) }
func (s Z) SetI16vec(v C.Int16List) {
	C.Struct(s).SetUint16(0, 19)
	C.Struct(s).SetPointer(0, C.Pointer(v))
}
func (s Z) I8vec() C.Int8List { return C.Int8List(C.Struct(s).Pointer(0)) }
func (s Z) SetI8vec(v C.Int8List) {
	C.Struct(s).SetUint16(0, 20)
	C.Struct(s).SetPointer(0, C.Pointer(v))
}
func (s Z) U64vec() C.UInt64List { return C.UInt64List(C.Struct(s).Pointer(0)) }
func (s Z) SetU64vec(v C.UInt64List) {
	C.Struct(s).SetUint16(0, 21)
	C.Struct(s).SetPointer(0, C.Pointer(v))
}
func (s Z) U32vec() C.UInt32List { return C.UInt32List(C.Struct(s).Pointer(0)) }
func (s Z) SetU32vec(v C.UInt32List) {
	C.Struct(s).SetUint16(0, 22)
	C.Struct(s).SetPointer(0, C.Pointer(v))
}
func (s Z) U16vec() C.UInt16List { return C.UInt16List(C.Struct(s).Pointer(0)) }
func (s Z) SetU16vec(v C.UInt16List) {
	C.Struct(s).SetUint16(0, 23)
	C.Struct(s).SetPointer(0, C.Pointer(v))
}
func (s Z) U8vec() C.UInt8List { return C.UInt8List(C.Struct(s).Pointer(0)) }
func (s Z) SetU8vec(v C.UInt8List) {
	C.Struct(s).SetUint16(0, 24)
	C.Struct(s).SetPointer(0, C.Pointer(v))
}
func (s Z) Zvec() Z_List           { return Z_List(C.Struct(s).Pointer(0)) }
func (s Z) SetZvec(v Z_List)       { C.Struct(s).SetUint16(0, 25); C.Struct(s).SetPointer(0, C.Pointer(v)) }
func (s Z) Zvecvec() C.PointerList { return C.PointerList(C.Struct(s).Pointer(0)) }
func (s Z) SetZvecvec(v C.PointerList) {
	C.Struct(s).SetUint16(0, 26)
	C.Struct(s).SetPointer(0, C.Pointer(v))
}
func (s Z) Zdate() Zdate               { return Zdate(C.Struct(s).Pointer(0).ToStruct()) }
func (s Z) SetZdate(v Zdate)           { C.Struct(s).SetUint16(0, 27); C.Struct(s).SetPointer(0, C.Pointer(v)) }
func (s Z) Zdata() Zdata               { return Zdata(C.Struct(s).Pointer(0).ToStruct()) }
func (s Z) SetZdata(v Zdata)           { C.Struct(s).SetUint16(0, 28); C.Struct(s).SetPointer(0, C.Pointer(v)) }
func (s Z) Aircraftvec() Aircraft_List { return Aircraft_List(C.Struct(s).Pointer(0)) }
func (s Z) SetAircraftvec(v Aircraft_List) {
	C.Struct(s).SetUint16(0, 29)
	C.Struct(s).SetPointer(0, C.Pointer(v))
}
func (s Z) Aircraft() Aircraft { return Aircraft(C.Struct(s).Pointer(0).ToStruct()) }
func (s Z) SetAircraft(v Aircraft) {
	C.Struct(s).SetUint16(0, 30)
	C.Struct(s).SetPointer(0, C.Pointer(v))
}
func (s Z) Regression() Regression { return Regression(C.Struct(s).Pointer(0).ToStruct()) }
func (s Z) SetRegression(v Regression) {
	C.Struct(s).SetUint16(0, 31)
	C.Struct(s).SetPointer(0, C.Pointer(v))
}
func (s Z) Planebase() PlaneBase { return PlaneBase(C.Struct(s).Pointer(0).ToStruct()) }
func (s Z) SetPlanebase(v PlaneBase) {
	C.Struct(s).SetUint16(0, 32)
	C.Struct(s).SetPointer(0, C.Pointer(v))
}
func (s Z) Airport() Airport     { return Airport(C.Struct(s).Uint16(8)) }
func (s Z) SetAirport(v Airport) { C.Struct(s).SetUint16(0, 33); C.Struct(s).SetUint16(8, uint16(v)) }
func (s Z) B737() B737           { return B737(C.Struct(s).Pointer(0).ToStruct()) }
func (s Z) SetB737(v B737)       { C.Struct(s).SetUint16(0, 34); C.Struct(s).SetPointer(0, C.Pointer(v)) }
func (s Z) A320() A320           { return A320(C.Struct(s).Pointer(0).ToStruct()) }
func (s Z) SetA320(v A320)       { C.Struct(s).SetUint16(0, 35); C.Struct(s).SetPointer(0, C.Pointer(v)) }
func (s Z) F16() F16             { return F16(C.Struct(s).Pointer(0).ToStruct()) }
func (s Z) SetF16(v F16)         { C.Struct(s).SetUint16(0, 36); C.Struct(s).SetPointer(0, C.Pointer(v)) }
func (s Z) Zdatevec() Zdate_List { return Zdate_List(C.Struct(s).Pointer(0)) }
func (s Z) SetZdatevec(v Zdate_List) {
	C.Struct(s).SetUint16(0, 37)
	C.Struct(s).SetPointer(0, C.Pointer(v))
}
func (s Z) Zdatavec() Zdata_List { return Zdata_List(C.Struct(s).Pointer(0)) }
func (s Z) SetZdatavec(v Zdata_List) {
	C.Struct(s).SetUint16(0, 38)
	C.Struct(s).SetPointer(0, C.Pointer(v))
}
func (s Z) Boolvec() C.BitList { return C.BitList(C.Struct(s).Pointer(0)) }
func (s Z) SetBoolvec(v C.BitList) {
	C.Struct(s).SetUint16(0, 39)
	C.Struct(s).SetPointer(0, C.Pointer(v))
}

type Z_List C.PointerList

func NewZ_List(s *C.Segment, sz int32) Z_List {
...
func (s Z_List) Set(i int, item Z) { C.PointerList(s).Set(i, C.Pointer(item)) }
...
func (s Counter) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

func (s Counter) Size() int64              { return int64(C.Struct(s).Uint64(0)) }
func (s Counter) SetSize(v int64)          { C.Struct(s).SetUint64(0, uint64(v)) }
func (s Counter) Words() string            { return C.Struct(s).Pointer(0).ToText() }
func (s Counter) SetWords(v string)        { C.Struct(s).SetPointer(0, s.Segment().NewText(v)) }
func (s Counter) Wordlist() C.TextList     { return C.TextList(C.Struct(s).Pointer(1)) }
func (s Counter) SetWordlist(v C.TextList) { C.Struct(s).SetPointer(1, C.Pointer(v)) }

type Counter_List C.PointerList

func NewCounter_List(s *C.Segment, sz int32) Counter_List {
...
func (s Counter_List) Set(i int, item Counter) { C.PointerList(s).Set(i, C.Pointer(item)) }
...
func (s Bag) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

func (s Bag) Counter() Counter     { return Counter(C.Struct(s).Pointer(0).ToStruct()) }
func (s Bag) SetCounter(v Counter) { C.Struct(s).SetPointer(0, C.Pointer(v)) }

type Bag_List C.PointerList

func NewBag_List(s *C.Segment, sz int32) Bag_List {
...
func (s Bag_List) Set(i int, item Bag) { C.PointerList(s).Set(i, C.Pointer(item)) }
...
func (s Zserver) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

func (s Zserver) Waitingjobs() Zjob_List     { return Zjob_List(C.Struct(s).Pointer(0)) }
func (s Zserver) SetWaitingjobs(v Zjob_List) { C.Struct(s).SetPointer(0, C.Pointer(v)) }

type Zserver_List C.PointerList

func NewZserver_List(s *C.Segment, sz int32) Zserver_List {
...
func (s Zserver_List) Set(i int, item Zserver) { C.PointerList(s).Set(i, C.Pointer(item)) }
...
func (s Zjob) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

func (s Zjob) Cmd() string          { return C.Struct(s).Pointer(0).ToText() }
func (s Zjob) SetCmd(v string)      { C.Struct(s).SetPointer(0, s.Segment().NewText(v)) }
func (s Zjob) Args() C.TextList     { return C.TextList(C.Struct(s).Pointer(1)) }
func (s Zjob) SetArgs(v C.TextList) { C.Struct(s).SetPointer(1, C.Pointer(v)) }

type Zjob_List C.PointerList

func NewZjob_List(s *C.Segment, sz int32) Zjob_List {
...
func (s Zjob_List) Set(i int, item Zjob) { C.PointerList(s).Set(i, C.Pointer(item)) }
...
func (s VerEmpty) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

type VerEmpty_List C.PointerList

func NewVerEmpty_List(s *C.Segment, sz int32) VerEmpty_List {
...
func (s VerEmpty_List) Set(i int, item VerEmpty) { C.PointerList(s).Set(i, C.Pointer(item)) }
...
func (s VerOneData) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

func (s VerOneData) Val() int16     { return int16(C.Struct(s).Uint16(0)) }
func (s VerOneData) SetVal(v int16) { C.Struct(s).SetUint16(0, uint16(v)) }

type VerOneData_List C.PointerList

func NewVerOneData_List(s *C.Segment, sz int32) VerOneData_List {
...
func (s VerOneData_List) Set(i int, item VerOneData) { C.PointerList(s).Set(i, C.Pointer(item)) }
...
func (s VerTwoData) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

func (s VerTwoData) Val() int16     { return int16(C.Struct(s).Uint16(0)) }
func (s VerTwoData) SetVal(v int16) { C.Struct(s).SetUint16(0, uint16(v)) }
func (s VerTwoData) Duo() int64     { return int64(C.Struct(s).Uint64(8)) }
func (s VerTwoData) SetDuo(v int64) { C.Struct(s).SetUint64(8, uint64(v)) }

type VerTwoData_List C.PointerList

func NewVerTwoData_List(s *C.Segment, sz int32) VerTwoData_List {
...
func (s VerTwoData_List) Set(i int, item VerTwoData) { C.PointerList(s).Set(i, C.Pointer(item)) }
...
func (s VerOnePtr) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

func (s VerOnePtr) Ptr() VerOneData     { return VerOneData(C.Struct(s).Pointer(0).ToStruct()) }
func (s VerOnePtr) SetPtr(v VerOneData) { C.Struct(s).SetPointer(0, C.Pointer(v)) }

type VerOnePtr_List C.PointerList

func NewVerOnePtr_List(s *C.Segment, sz int32) VerOnePtr_List {
...
func (s VerOnePtr_List) Set(i int, item VerOnePtr) { C.PointerList(s).Set(i, C.Pointer(item)) }
...
func (s VerTwoPtr) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

func (s VerTwoPtr) Ptr1() VerOneData     { return VerOneData(C.Struct(s).Pointer(0).ToStruct()) }
func (s VerTwoPtr) SetPtr1(v VerOneData) { C.Struct(s).SetPointer(0, C.Pointer(v)) }
func (s VerTwoPtr) Ptr2() VerOneData     { return VerOneData(C.Struct(s).Pointer(1).ToStruct()) }
func (s VerTwoPtr) SetPtr2(v VerOneData) { C.Struct(s).SetPointer(1, C.Pointer(v)) }

type VerTwoPtr_List C.PointerList

func NewVerTwoPtr_List(s *C.Segment, sz int32) VerTwoPtr_List {
...
func (s VerTwoPtr_List) Set(i int, item VerTwoPtr) { C.PointerList(s).Set(i, C.Pointer(item)) }
...
func (s VerTwoDataTwoPtr) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

func (s VerTwoDataTwoPtr) Val() int16           { return int16(C.Struct(s).Uint16(0)) }
func (s VerTwoDataTwoPtr) SetVal(v int16)       { C.Struct(s).SetUint16(0, uint16(v)) }
func (s VerTwoDataTwoPtr) Duo() int64           { return int64(C.Struct(s).Uint64(8)) }
func (s VerTwoDataTwoPtr) SetDuo(v int64)       { C.Struct(s).SetUint64(8, uint64(v)) }
func (s VerTwoDataTwoPtr) Ptr1() VerOneData     { return VerOneData(C.Struct(s).Pointer(0).ToStruct()) }
func (s VerTwoDataTwoPtr) SetPtr1(v VerOneData) { C.Struct(s).SetPointer(0, C.Pointer(v)) }
func (s VerTwoDataTwoPtr) Ptr2() VerOneData     { return VerOneData(C.Struct(s).Pointer(1).ToStruct()) }
func (s VerTwoDataTwoPtr) SetPtr2(v VerOneData) { C.Struct(s).SetPointer(1, C.Pointer(v)) }

type VerTwoDataTwoPtr_List C.PointerList

func NewVerTwoDataTwoPtr_List(s *C.Segment, sz int32) VerTwoDataTwoPtr_List {
...
func (s HoldsVerEmptyList) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

func (s HoldsVerEmptyList) Mylist() VerEmpty_List     { return VerEmpty_List(C.Struct(s).Pointer(0)) }
func (s HoldsVerEmptyList) SetMylist(v VerEmpty_List) { C.Struct(s).SetPointer(0, C.Pointer(v)) }

type HoldsVerEmptyList_List C.PointerList

func NewHoldsVerEmptyList_List(s *C.Segment, sz int32) HoldsVerEmptyList_List {
...
func (s HoldsVerOneDataList) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

func (s HoldsVerOneDataList) Mylist() VerOneData_List     { return VerOneData_List(C.Struct(s).Pointer(0)) }
func (s HoldsVerOneDataList) SetMylist(v VerOneData_List) { C.Struct(s).SetPointer(0, C.Pointer(v)) }

type HoldsVerOneDataList_List C.PointerList

func NewHoldsVerOneDataList_List(s *C.Segment, sz int32) HoldsVerOneDataList_List {
...
func (s HoldsVerTwoDataList) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

func (s HoldsVerTwoDataList) Mylist() VerTwoData_List     { return VerTwoData_List(C.Struct(s).Pointer(0)) }
func (s HoldsVerTwoDataList) SetMylist(v VerTwoData_List) { C.Struct(s).SetPointer(0, C.Pointer(v)) }

type HoldsVerTwoDataList_List C.PointerList

func NewHoldsVerTwoDataList_List(s *C.Segment, sz int32) HoldsVerTwoDataList_List {
...
func (s HoldsVerOnePtrList) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

func (s HoldsVerOnePtrList) Mylist() VerOnePtr_List     { return VerOnePtr_List(C.Struct(s).Pointer(0)) }
func (s HoldsVerOnePtrList) SetMylist(v VerOnePtr_List) { C.Struct(s).SetPointer(0, C.Pointer(v)) }

type HoldsVerOnePtrList_List C.PointerList

func NewHoldsVerOnePtrList_List(s *C.Segment, sz int32) HoldsVerOnePtrList_List {
...
func (s HoldsVerTwoPtrList) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

func (s HoldsVerTwoPtrList) Mylist() VerTwoPtr_List     { return VerTwoPtr_List(C.Struct(s).Pointer(0)) }
func (s HoldsVerTwoPtrList) SetMylist(v VerTwoPtr_List) { C.Struct(s).SetPointer(0, C.Pointer(v)) }

type HoldsVerTwoPtrList_List C.PointerList

func NewHoldsVerTwoPtrList_List(s *C.Segment, sz int32) HoldsVerTwoPtrList_List {
...
func (s HoldsVerTwoTwoList) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

func (s HoldsVerTwoTwoList) Mylist() VerTwoDataTwoPtr_List {
	return VerTwoDataTwoPtr_List(C.Struct(s).Pointer(0))
}
func (s HoldsVerTwoTwoList) SetMylist(v VerTwoDataTwoPtr_List) {
	C.Struct(s).SetPointer(0, C.Pointer(v))
}

type HoldsVerTwoTwoList_List C.PointerList

func NewHoldsVerTwoTwoList_List(s *C.Segment, sz int32) HoldsVerTwoTwoList_List {
...
func (s HoldsVerTwoTwoPlus) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

func (s HoldsVerTwoTwoPlus) Mylist() VerTwoTwoPlus_List {
	return VerTwoTwoPlus_List(C.Struct(s).Pointer(0))
}
func (s HoldsVerTwoTwoPlus) SetMylist(v VerTwoTwoPlus_List) { C.Struct(s).SetPointer(0, C.Pointer(v)) }

type HoldsVerTwoTwoPlus_List C.PointerList

func NewHoldsVerTwoTwoPlus_List(s *C.Segment, sz int32) HoldsVerTwoTwoPlus_List {
...
func (s VerTwoTwoPlus) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

func (s VerTwoTwoPlus) Val() int16     { return int16(C.Struct(s).Uint16(0)) }
func (s VerTwoTwoPlus) SetVal(v int16) { C.Struct(s).SetUint16(0, uint16(v)) }
func (s VerTwoTwoPlus) Duo() int64     { return int64(C.Struct(s).Uint64(8)) }
func (s VerTwoTwoPlus) SetDuo(v int64) { C.Struct(s).SetUint64(8, uint64(v)) }
func (s VerTwoTwoPlus) Ptr1() VerTwoDataTwoPtr {
	return VerTwoDataTwoPtr(C.Struct(s).Pointer(0).ToStruct())
}
func (s VerTwoTwoPlus) SetPtr1(v VerTwoDataTwoPtr) { C.Struct(s).SetPointer(0, C.Pointer(v)) }
func (s VerTwoTwoPlus) Ptr2() VerTwoDataTwoPtr {
	return VerTwoDataTwoPtr(C.Struct(s).Pointer(1).ToStruct())
}
func (s VerTwoTwoPlus) SetPtr2(v VerTwoDataTwoPtr) { C.Struct(s).SetPointer(1, C.Pointer(v)) }
func (s VerTwoTwoPlus) Tre() int64                 { return int64(C.Struct(s).Uint64(16)) }
func (s VerTwoTwoPlus) SetTre(v int64)             { C.Struct(s).SetUint64(16, uint64(v)) }
func (s VerTwoTwoPlus) Lst3() C.Int64List          { return C.Int64List(C.Struct(s).Pointer(2)) }
func (s VerTwoTwoPlus) SetLst3(v C.Int64List)      { C.Struct(s).SetPointer(2, C.Pointer(v)) }

type VerTwoTwoPlus_List C.PointerList

func NewVerTwoTwoPlus_List(s *C.Segment, sz int32) VerTwoTwoPlus_List {
...
func (s VerTwoTwoPlus_List) Set(i int, item VerTwoTwoPlus) { C.PointerList(s).Set(i, C.Pointer(item)) }
...
func (s HoldsText) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

func (s HoldsText) Txt() string               { return C.Struct(s).Pointer(0).ToText() }
func (s HoldsText) SetTxt(v string)           { C.Struct(s).SetPointer(0, s.Segment().NewText(v)) }
func (s HoldsText) Lst() C.TextList           { return C.TextList(C.Struct(s).Pointer(1)) }
func (s HoldsText) SetLst(v C.TextList)       { C.Struct(s).SetPointer(1, C.Pointer(v)) }
func (s HoldsText) Lstlst() C.PointerList     { return C.PointerList(C.Struct(s).Pointer(2)) }
func (s HoldsText) SetLstlst(v C.PointerList) { C.Struct(s).SetPointer(2, C.Pointer(v)) }

type HoldsText_List C.PointerList

func NewHoldsText_List(s *C.Segment, sz int32) HoldsText_List {
...
func (s HoldsText_List) Set(i int, item HoldsText) { C.PointerList(s).Set(i, C.Pointer(item)) }
...
func (s WrapEmpty) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

func (s WrapEmpty) MightNotBeReallyEmpty() VerEmpty {
	return VerEmpty(C.Struct(s).Pointer(0).ToStruct())
}
func (s WrapEmpty) SetMightNotBeReallyEmpty(v VerEmpty) { C.Struct(s).SetPointer(0, C.Pointer(v)) }

type WrapEmpty_List C.PointerList

func NewWrapEmpty_List(s *C.Segment, sz int32) WrapEmpty_List {
...
func (s WrapEmpty_List) Set(i int, item WrapEmpty) { C.PointerList(s).Set(i, C.Pointer(item)) }
...
func (s Wrap2x2) Segment() *C.Segment {
	return C.Struct(s).Segment()
}
...
func (s Wrap2x2) SetMightNotBeReallyEmpty(v VerTwoDataTwoPtr) { C.Struct(s).SetPointer(0, C.Pointer(v)) }

type Wrap2x2_List C.PointerList

func NewWrap2x2_List(s *C.Segment, sz int32) Wrap2x2_List {
...
func (s Wrap2x2_List) Set(i int, item Wrap2x2) { C.PointerList(s).Set(i, C.Pointer(item)) }
...
func (s Wrap2x2plus) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

func (s Wrap2x2plus) MightNotBeReallyEmpty() VerTwoTwoPlus {
	return VerTwoTwoPlus(C.Struct(s).Pointer(0).ToStruct())
}
...
func NewWrap2x2plus_List(s *C.Segment, sz int32) Wrap2x2plus_List {
...
func (s Wrap2x2plus_List) Set(i int, item Wrap2x2plus) { C.PointerList(s).Set(i, C.Pointer(item)) }
...
func (s Endpoint) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

func (s Endpoint) Ip() net.IP           { return net.IP(C.Struct(s).Pointer(0).ToData()) }
func (s Endpoint) SetIp(v net.IP)       { C.Struct(s).SetPointer(0, s.Segment().NewData([]byte(v))) }
func (s Endpoint) Port() int16          { return int16(C.Struct(s).Uint16(0)) }
func (s Endpoint) SetPort(v int16)      { C.Struct(s).SetUint16(0, uint16(v)) }
func (s Endpoint) Hostname() string     { return C.Struct(s).Pointer(1).ToText() }
func (s Endpoint) SetHostname(v string) { C.Struct(s).SetPointer(1, s.Segment().NewText(v)) }

type Endpoint_List C.PointerList

func NewEndpoint_List(s *C.Segment, sz int32) Endpoint_List {
...
func (s Endpoint_List) Set(i int, item Endpoint) { C.PointerList(s).Set(i, C.Pointer(item)) }
...
func (s VoidUnion) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

func (s VoidUnion) Which() VoidUnion_Which {
	return VoidUnion_Which(C.Struct(s).Uint16(0))
}

func (s VoidUnion) SetA() { C.Struct(s).SetUint16(0, 0) }
func (s VoidUnion) SetB() { C.Struct(s).SetUint16(0, 1) }

type VoidUnion_List C.PointerList

func NewVoidUnion_List(s *C.Segment, sz int32) VoidUnion_List {
...
func (s VoidUnion_List) Set(i int, item VoidUnion) { C.PointerList(s).Set(i, C.Pointer(item)) }
...
func (s Nester1Capn) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

func (s Nester1Capn) Strs() C.TextList     { return C.TextList(C.Struct(s).Pointer(0)) }
func (s Nester1Capn) SetStrs(v C.TextList) { C.Struct(s).SetPointer(0, C.Pointer(v)) }

type Nester1Capn_List C.PointerList

func NewNester1Capn_List(s *C.Segment, sz int32) Nester1Capn_List {
...
func (s Nester1Capn_List) Set(i int, item Nester1Capn) { C.PointerList(s).Set(i, C.Pointer(item)) }
...
func (s RWTestCapn) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

func (s RWTestCapn) NestMatrix() C.PointerList     { return C.PointerList(C.Struct(s).Pointer(0)) }
func (s RWTestCapn) SetNestMatrix(v C.PointerList) { C.Struct(s).SetPointer(0, C.Pointer(v)) }

type RWTestCapn_List C.PointerList

func NewRWTestCapn_List(s *C.Segment, sz int32) RWTestCapn_List {
...
func (s RWTestCapn_List) Set(i int, item RWTestCapn) { C.PointerList(s).Set(i, C.Pointer(item)) }
...
func (s ListStructCapn) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

func (s ListStructCapn) Vec() Nester1Capn_List     { return Nester1Capn_List(C.Struct(s).Pointer(0)) }
func (s ListStructCapn) SetVec(v Nester1Capn_List) { C.Struct(s).SetPointer(0, C.Pointer(v)) }

type ListStructCapn_List C.PointerList

func NewListStructCapn_List(s *C.Segment, sz int32) ListStructCapn_List {
...
func (s ListStructCapn_List) Set(i int, item ListStructCapn) { C.PointerList(s).Set(i, C.Pointer(item)) }
...
func (s Echo_echo_Params) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

func (s Echo_echo_Params) In() string     { return C.Struct(s).Pointer(0).ToText() }
func (s Echo_echo_Params) SetIn(v string) { C.Struct(s).SetPointer(0, s.Segment().NewText(v)) }

type Echo_echo_Params_List C.PointerList

func NewEcho_echo_Params_List(s *C.Segment, sz int32) Echo_echo_Params_List {
...
func (s Echo_echo_Results) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

func (s Echo_echo_Results) Out() string     { return C.Struct(s).Pointer(0).ToText() }
func (s Echo_echo_Results) SetOut(v string) { C.Struct(s).SetPointer(0, s.Segment().NewText(v)) }

type Echo_echo_Results_List C.PointerList

func NewEcho_echo_Results_List(s *C.Segment, sz int32) Echo_echo_Results_List {
...
func (s Hoth) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

func (s Hoth) Base() EchoBase     { return EchoBase(C.Struct(s).Pointer(0).ToStruct()) }
func (s Hoth) SetBase(v EchoBase) { C.Struct(s).SetPointer(0, C.Pointer(v)) }

type Hoth_List C.PointerList

func NewHoth_List(s *C.Segment, sz int32) Hoth_List {
...
func (s Hoth_List) Set(i int, item Hoth) { C.PointerList(s).Set(i, C.Pointer(item)) }
...
func (s EchoBase) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

func (s EchoBase) Echo() Echo { return NewEcho(C.Struct(s).Pointer(0).ToInterface().Client()) }
...
func NewEchoBase_List(s *C.Segment, sz int32) EchoBase_List {
...
func (s EchoBase_List) Set(i int, item EchoBase) { C.PointerList(s).Set(i, C.Pointer(item)) }
...
func (s StackingRoot) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

func (s StackingRoot) A() StackingA     { return StackingA(C.Struct(s).Pointer(1).ToStruct()) }
func (s StackingRoot) SetA(v StackingA) { C.Struct(s).SetPointer(1, C.Pointer(v)) }
func (s StackingRoot) AWithDefault() StackingA {
	return StackingA(C.Struct(s).Pointer(0).ToStructDefault(x_832bcc6686a26d56, 0))
}
func (s StackingRoot) SetAWithDefault(v StackingA) { C.Struct(s).SetPointer(0, C.Pointer(v)) }

type StackingRoot_List C.PointerList

func NewStackingRoot_List(s *C.Segment, sz int32) StackingRoot_List {
...
func (s StackingRoot_List) Set(i int, item StackingRoot) { C.PointerList(s).Set(i, C.Pointer(item)) }
...
func (p *StackingRoot_Promise) AWithDefault() *StackingA_Promise {
	return (*StackingA_Promise)((*C.Pipeline)(p).GetPipelineDefault(0, x_832bcc6686a26d56, 24))
}
...
func (s StackingA) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

func (s StackingA) Num() int32       { return int32(C.Struct(s).Uint32(0)) }
func (s StackingA) SetNum(v int32)   { C.Struct(s).SetUint32(0, uint32(v)) }
func (s StackingA) B() StackingB     { return StackingB(C.Struct(s).Pointer(0).ToStruct()) }
func (s StackingA) SetB(v StackingB) { C.Struct(s).SetPointer(0, C.Pointer(v)) }

type StackingA_List C.PointerList

func NewStackingA_List(s *C.Segment, sz int32) StackingA_List {
...
func (s StackingA_List) Set(i int, item StackingA) { C.PointerList(s).Set(i, C.Pointer(item)) }
...
func (s StackingB) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

func (s StackingB) Num() int32     { return int32(C.Struct(s).Uint32(0)) }
func (s StackingB) SetNum(v int32) { C.Struct(s).SetUint32(0, uint32(v)) }

type StackingB_List C.PointerList

func NewStackingB_List(s *C.Segment, sz int32) StackingB_List {
...
func (s StackingB_List) Set(i int, item StackingB) { C.PointerList(s).Set(i, C.Pointer(item)) }
...
func (s CallSequence_getNumber_Params) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

type CallSequence_getNumber_Params_List C.PointerList

func NewCallSequence_getNumber_Params_List(s *C.Segment, sz int32) CallSequence_getNumber_Params_List {
...
func (s CallSequence_getNumber_Results) Segment() *C.Segment {
	return C.Struct(s).Segment()
}

func (s CallSequence_getNumber_Results) N() uint32     { return C.Struct(s).Uint32(0) }
func (s CallSequence_getNumber_Results) SetN(v uint32) { C.Struct(s).SetUint32(0, v) }

type CallSequence_getNumber_Results_List C.PointerList

func NewCallSequence_getNumber_Results_List(s *C.Segment, sz int32) CallSequence_getNumber_Results_List {
