...
func (s Node) SetParameters(v Node_Parameter_List) error {
	...
	return s.Struct.SetPtr(5, capnp.Ptr{List: v.List})
}
...
func (s Node_structGroup) SetFields(v Field_List) error {
	...
	return s.Struct.SetPtr(3, capnp.Ptr{List: v.List})
}
...
func (s Node_interface) SetSuperclasses(v Superclass_List) error {
	...
	return s.Struct.SetPtr(4, capnp.Ptr{List: v.List})
}
...
func (s Node_const) SetType(v Type) error {
	...
	return s.Struct.SetPtr(3, capnp.Ptr{Struct: v.Struct})
}
...
func (s Node_const) NewType() (Type, error) {
	...
	err = s.Struct.SetPtr(3, capnp.Ptr{Struct: ss.Struct})
	return ss, err
}
...
func (s Node_const) SetValue(v Value) error {
	...
	return s.Struct.SetPtr(4, capnp.Ptr{Struct: v.Struct})
}
...
func (s Node_const) NewValue() (Value, error) {
	...
	err = s.Struct.SetPtr(4, capnp.Ptr{Struct: ss.Struct})
	return ss, err
}
...
func (s Field_slot) SetType(v Type) error {
	...
	return s.Struct.SetPtr(2, capnp.Ptr{Struct: v.Struct})
}
...
func (s Field_slot) NewType() (Type, error) {
	...
	err = s.Struct.SetPtr(2, capnp.Ptr{Struct: ss.Struct})
	return ss, err
}
